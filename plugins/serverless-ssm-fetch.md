...
By default, there is nothing more to do if you want _all_ your SSM Parameters injected in _all_ your functions.
...
This will add _ONLY_ the SSM Parameter `APP_ID` to the function environment variables. In this case, the function `hello` will be pushed to AWS Lambda with environment variables `NODE_ENV` and `APP_ID`.
